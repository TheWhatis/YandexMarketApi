...
class GoodsStatsGoodsDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'storage' => '\OpenAPI\Client\Model\GoodsStatsStorageDTO[]',
    ...
    */
     ...
     * Sets warehouses
     *
     * @param \OpenAPI\Client\Model\GoodsStatsWarehouseDTO[]|null $warehouses Информация о складах, на которых хранится товар.
     *
     * @return self
     */
     ...
     * Gets storage
     *
     * @return \OpenAPI\Client\Model\GoodsStatsStorageDTO[]|null
     */
     ...
     * Sets storage
     *
     * @param \OpenAPI\Client\Model\GoodsStatsStorageDTO[]|null $storage Информация об условиях хранения и обработки товара на складе.
     *
     * @return self
     */
