...
/**
 * UpdatePriceWithDiscountDTOAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePriceWithDiscountDTOAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePriceWithDiscountDTO_allOf';
    ...
    */
    ...
    public function setDiscountBase($discount_base)
    {
        ...
        if (($discount_base <= 0)) {
            throw new \InvalidArgumentException('invalid value for $discount_base when calling UpdatePriceWithDiscountDTOAllOf., must be bigger than 0.');
        }
