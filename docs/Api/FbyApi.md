...
```php
getActualStocks($campaign_id, $warehouse_id, $sku): \OpenAPI\Client\Model\GetStocksResponse
```
...
[**\OpenAPI\Client\Model\GetStocksResponse**](../Model/GetStocksResponse.md)
...
```php
getOrderDeliveryOptions($campaign_id, $get_order_delivery_options_request): \OpenAPI\Client\Model\GetOrderDeliveryOptionsResponse
```
...
$campaign_id = 56; // int | Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**.
$get_order_delivery_options_request = new \OpenAPI\Client\Model\GetOrderDeliveryOptionsRequest(); // \OpenAPI\Client\Model\GetOrderDeliveryOptionsRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **campaign_id** | **int**| Идентификатор кампании и идентификатор магазина. Каждая кампания в API соответствует магазину в кабинете.  **Где его взять**  Войдите в личный кабинет, в меню слева выберите **Настройки** → **Настройки API** и скопируйте число из поля **Номер кампании**. | |
| **get_order_delivery_options_request** | [**\OpenAPI\Client\Model\GetOrderDeliveryOptionsRequest**](../Model/GetOrderDeliveryOptionsRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\GetOrderDeliveryOptionsResponse**](../Model/GetOrderDeliveryOptionsResponse.md)
